...
Pada pertemuan 5 Bahasa Pemrograman saya diberi tugas oleh Dosen untuk membuat Aplikasi Biodata Python (seperti Gambar dibawah ini)<br><br>
...
![gitpush](gambar/tugaspertemuan5.png) <br>
